...
;; POP method => Removes the top item from the stack => Built-in Clojure function
...
(println .stack)
;; PUSH test
(println "\nPUSH (each time adds an item to the top of the stack): ")
(push .stack 3)
(println .stack)
(push .stack 2)
(println .stack)
...
(println .stack)
;; POP test
(println "\nPOP (each time removes the top item from the stack): ")
(def .stack (pop .stack))
(println .stack)
(def .stack (pop .stack))
(println .stack)

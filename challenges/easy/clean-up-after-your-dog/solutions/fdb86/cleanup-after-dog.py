...
cleanUp([['@','@'], ['@','@'], ['@','@']], 2, 2) # 'Cr@p'
cleanUp([['_','_','_','_','D','_','_','_','_'], ['_','_','_','_','@','@','_','_','_'],
         ['_','_','_','_','_','_','D','_','_']], 9, 5) # 'Dog!!'
cleanUp([['_','_','_','_','_']], 6, 9) # 'Clean'
cleanUp([['_','_','D','_','_','_','_','_','D'], ['_','_','D','_','_','_','_','_','_'],
         ['_','_','_','_','_','@','_','_','_']] , 4, 4) # 'Dog!!'
cleanUp([['_','@','@'], ['_','@','@']], 1, 2) # 'Cr@p'
cleanUp([['_','_','_','_','_','_','_','@'], ['_','_','_','@','D','_','_','_'], ['_','_','_','_','_','_','D','_'],
         ['_','_','_','_','D','_','_','_'], ['_','_','_','_','D','@','_','_']], 1, 6) # 'Dog!!'
